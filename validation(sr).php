...
$query = "select * from studentsr where email='$email'";
...
{
	$insert = "INSERT INTO `studentsr`(`Name`, `Username`, `Password`, `Gender`, `Email`, `Phone`, `Address`) VALUES ('$name','$username','$password','$gender','$email','$phonenumber','$address')";
